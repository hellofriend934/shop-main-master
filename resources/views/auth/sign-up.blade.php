...
@section('content')
    <x-forms.auth-forms title="регистрация" action="{{route('signUp')}}" xmlns:x-slot="http://www.w3.org/1999/html"><form class="space-y-3">
            ...
            <x-forms.text-input :isError="$errors->has('password_confirmation')" type="password_confirmation" name="password_confirmation" placeholder="password_confirmation" required="true" />
